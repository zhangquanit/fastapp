            ...
            if (requestBody != null) {
                for (int i = 0; i < requestBody.size(); i++) {
                    ...
                    /*
                     ...
                     需使用MultipartBody.Part.createFormData(String username, @Nullable String filename, RequestBody body)方法，
                     ...
                     2.若MultipartBody.Part作为普通参数载体，建议使用MultipartBody.Part.createFormData(String username, String value)方法创建Part实例
                    ...
                    /*
                      ...
                      b.构造MultipartBody.Part实例参数时,推荐使用MultipartBody.Part.createFormData(String username, String value)方法，或使用以下方法
...
//                .build();
    ...
    private Request rebuildGetRequest(Request request) {
        ...
        return requestBuilder.url(url.toString()).build();
    }
}