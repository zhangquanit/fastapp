...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_text_normal));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.tab_text_normal));
        mTvTitle.setLayoutParams(paramsTv);
        lLContainer.addView(mTvTitle);

        addView(lLContainer);

        int min = dip2px(context, 16);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tab_text_selected));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tab_text_selected));
        } else {
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tab_text_normal));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tab_text_normal));
        }
