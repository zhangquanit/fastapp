...
public class IndicatorView extends FrameLayout {
     ...
     * 设置实心圆indicator
     *
     * @param pageCount       ViewPager页数
     * @param intervalValue       两个indicator之间的距离,单位：dip
     * @param norIndicatorRes 正常显示的indicator图片资源id
     * @param selIndicatorRes 移动的indicator图片资源id
     */
     ...
     * @param pageCount     ViewPager页数
     * @param intervalValue 两个indicator之间的距离,单位：dip
     * @param norColor      正常显示的indicator颜色
     * @param selColor      移动显示的indicator颜色
     * @param indicatorSize 圆形indicator直径，单位 dp
     */
     ...
     * @param pageCount     ViewPager页数
     * @param intervalValue 两个indicator之间的距离,单位：dip
     * @param strokeColor   空心圆边框颜色
     * @param solidColor    实心圆颜色
     * @param indicatorSize 圆的直径 单位dip
     */
     ...
     * @param pageCount     ViewPager页数
     * @param intervalValue 两个indicator之间的距离,单位：dip
     * @param norIndicator  正常显示的indicator
     * @param selIndicator  移动显示的indicator
     */
     ...
     */
    public void setViewPager(ViewPager viewPager, final androidx.viewpager.widget.ViewPager.OnPageChangeListener pageChangeListener) {
    ...
    private void updateIndicator(int page, float per) {
        ...
        mIndicatorView.setTranslationX(x);
    }
